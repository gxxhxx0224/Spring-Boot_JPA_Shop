...
class OrderServiceTest {
    ...
    public void 상품주문() throws Exception{
        ...
        int orderCount=2;
        //when
        Long orderId = orderService.order(member.getId(), book.getId(), orderCount);//2건 주문
    ...
    @Test //@Test(expected=NotEnoughStockException.class) 대신
    public void 상품주문_재고수량초과() throws Exception{
        ...
        //then
        //JUnit4의 @Test(expected=~Exception.class)일때 fail() 사용
//        fail("재고 수량 부족 예외");
    ...
    private Member createMember() {
        ...
        member.setName("회원1");
        member.setAddress(new Address("서울","신촌로","11-51"));
        em.persist(member);
        return member;
    }
